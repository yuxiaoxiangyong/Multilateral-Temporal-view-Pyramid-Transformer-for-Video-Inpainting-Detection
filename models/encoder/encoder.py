...
from models.factory.modelFactory import create_multiswin, create_baseline
...
class Encoder(nn.Module):
    ...
    def forward(self, x, return_attention=False, layer_id=1):
        ...
        final_x = final_x if return_attention else rearrange(final_x, "b (h w) (p1 p2 c) -> b c (h p1) (w p2)", p1=1,
                                                             p2=1, h=ws, w=ws, c=out_channels)
