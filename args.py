...
def get_parser():
    ...
    ## TRAINING parameters ##
    parser.add_argument('--resume', dest='resume',action='store_true',  # resume 恢复
    ...
    parser.add_argument('-epoch_resume', dest='epoch_resume',default= 79,type=int,
    ...
    parser.add_argument('-seed', dest='seed',default = 282845927, type=int) # 123
    parser.add_argument('-gpu_id', dest='gpu_id',default = 0, type=int)
    
    parser.add_argument('-dset1', dest='dset1', default = "vi",type=str)
    parser.add_argument('-dset2', dest='dset2', default = "op",type=str)
    ...
    parser.add_argument('-weight_decay_cnn', dest='weight_decay_cnn', default = 1e-4, type=float)
    ...
    parser.add_argument('--keep_vit', dest='keep_vit', action='store_true',
                        help='used in sync with finetune_after. no need to activate.')
    parser.set_defaults(keep_vit=False)
    ...
    parser.add_argument('-base_model', dest='base_model', default = 'vgg16',
    ...
    parser.add_argument('-dataset', dest='dataset', default = 'davis2016',choices=['davis2016_vi','davis2016', 'davis2017', 'fvi', 'youtubevos', 'davis2016_new', 'youtubevos_new', 'test', 'davis'])
    ...
    parser.add_argument('-lr_cnn', dest='lr_cnn', default = 0.9,type=float)
    parser.add_argument('-lr_cva', dest='lr_cva', default = 1e-6,type=float)
